...
!function (a) {
    ...
    function e(b, c) {
        ...
        function e(c, e) {
            ...
            if (b.repeat > 0 || "*" == b.repeat || "+" == b.repeat) {
        ...
        var f = [];
        if (a.isFunction(b.mask) && (b.mask = b.mask.call(this, b)), a.isArray(b.mask))if (c)a.each(b.mask, function (b, c) {
        ...
        } else 1 == b.mask.length && 0 == b.greedy && 0 != b.repeat && (b.placeholder = ""), f = void 0 == b.mask.mask || a.isFunction(b.mask.mask) ? e(b.mask.toString(), b.mask) : e(b.mask.mask.toString(), b.mask);
        return f
    }
    ...
    function f(b, d, e) {
        function f(a, b, c) {
            ...
            var d, f, g, i = [], j = 0;
            do {
                if (a === !0 && h().validPositions[j]) {
                    var k = h().validPositions[j];
                    f = k.match, d = k.locator.slice(), i.push(null == f.fn ? f.def : c === !0 ? k.input : f.placeholder || e.placeholder.charAt(j % e.placeholder.length))
                } else {
                    if (b > j) {
                        var l = v(j, d, j - 1);
                        g = l[0]
                    } else g = s(j, d, j - 1);
                    f = g.match, d = g.locator.slice(), i.push(null == f.fn ? f.def : void 0 != f.placeholder ? f.placeholder : e.placeholder.charAt(j % e.placeholder.length))
                }
                j++
            } while ((void 0 == eb || eb > j - 1) && null != f.fn || null == f.fn && "" != f.def || b >= j);
            return i.pop(), i
        }
        ...
        function q(b, c, d) {
            if (e.insertMode && void 0 != h().validPositions[b] && void 0 == d) {
                ...
                if (!j)return h().validPositions = a.extend(!0, {}, g), !1
        ...
        function v(b, c, d) {
            ...
            }), h().tests[b] = a.extend(!0, [], k), h().tests[b]
        }
        ...
        function H(a, b) {
            return b = b || t(a), b.placeholder || (null == b.fn ? b.def : e.placeholder.charAt(a % e.placeholder.length))
        }
        ...
        function N(b, c, d) {
            ...
            if ("number" != typeof c) {
                ...
                return !a(g).is(":visible") && h && void 0 != h.caret ? (c = h.caret.begin, d = h.caret.end) : g.setSelectionRange ? (c = g.selectionStart, d = g.selectionEnd) : document.selection && document.selection.createRange && (f = document.selection.createRange(), c = 0 - f.duplicate().moveStart("character", -1e5), d = c + f.text.length), c = M(c), d = M(d), {
                    begin: c,
                    end: d
                }
            }
            ...
            }, a(g).data("_inputmask", h), a(g).is(":visible") && (g.scrollLeft = g.scrollWidth, 0 == e.insertMode && c == d && d++, g.setSelectionRange ? (g.selectionStart = c, g.selectionEnd = d) : g.createTextRange && (f = g.createTextRange(), f.collapse(!0), f.moveEnd("character", d), f.moveStart("character", c), f.select()))
        }
        ...
        function $(a) {
            if (hb === !0 && "input" == a.type)return hb = !1, !0;
        ...
        if (void 0 != b)switch (b.action) {
            ...
            case"mask":
                ...
                break;
            case"format":
                db = a({}), db.data("_inputmask", {
                    maskset: d,
                    opts: e,
                    isRTL: e.numericInput
                }), e.numericInput && (fb = !0);
                var jb = (a.isFunction(e.onBeforeMask) ? e.onBeforeMask.call(db, b.value, e) : b.value).split("");
                return I(db, !1, !1, fb ? jb.reverse() : jb, !0), e.onKeyPress.call(this, void 0, x(), 0, e), b.metadata ? {
    ...
    if (void 0 === a.fn.inputmask) {
        ...
        a.inputmask = {
            ...
            function j(b, c) {
                var d = a(b);
                for (var e in c) {
                    var f = d.data("inputmask-" + e.toLowerCase());
                    void 0 != f && (c[e] = f)
                }
                return c
            }
            ...
            if ("string" == typeof b)switch (b) {
                case"mask":
                    return j(this, l), d(l.alias, c, l), k = e(l, g !== f), 0 == k.length ? this : this.each(function () {
                        g({action: "mask", el: this}, a.extend(!0, {}, k), l)
                    });
                case"unmaskedvalue":
                    var m = a(this);
                ...
                default:
                    return j(this, l), d(l.alias, c, l), d(b, c, l) || (l.mask = b), k = e(l, g !== f), void 0 == k ? this : this.each(function () {
                        g({action: "mask", el: this}, a.extend(!0, {}, k), l)
                    })
            } else {
                if ("object" == typeof b)return l = a.extend(!0, {}, a.inputmask.defaults, b), j(this, l), d(l.alias, b, l), k = e(l, g !== f), void 0 == k ? this : this.each(function () {
                    g({action: "mask", el: this}, a.extend(!0, {}, k), l)
                });
                if (void 0 == b)return this.each(function () {
                    ...
                    if (b && "" != b)try {
                        ...
                        var e = a.parseJSON("{" + b + "}");
                        a.extend(!0, e, c), l = a.extend(!0, {}, a.inputmask.defaults, e), d(l.alias, e, l), l.alias = void 0, a(this).inputmask("mask", l, g)
                    } catch (f) {
                    }
                    (a(this).attr("data-inputmask-mask") || a(this).attr("data-inputmask-alias")) && a(this).inputmask("mask", {}, g)
                })
            }
        }
    }
    ...
    return a.extend(a.inputmask.defaults.definitions, {
        ...
        "mm/dd/yyyy": {
            ...
            }, leapday: "02/29/", onKeyUp: function (b, c, d, e) {
                var f = a(this);
                if (b.ctrlKey && b.keyCode == e.keyCode.RIGHT) {
                    var g = new Date;
    ...
    return a.extend(a.inputmask.defaults.aliases, {
        phone: {
            ...
            nojumps: !0,
            nojumpsThreshold: 1
        }, phonebe: {alias: "phone", url: "phone-codes/phone-be.js", maskInit: "+32(pp)pppppppp", nojumpsThreshold: 4}
    }), a.fn.inputmask
}(jQuery), function (a) {
    return a.extend(a.inputmask.defaults.aliases, {
        Regex: {
